  ...
  return (
    <div className="flex items-center space-x-8">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-between w-fit bg-primary p-5 rounded-lg text-white">
        ...
        <div className="flex-col">
          <div>
            <Skeleton skeletonStyling="w-[70px] h-3 rounded-lg" />
          </div>
          <div className="py-3">
    ...
    <div className="bg-[#ededed] rounded-3xl border-1">
      <div className="w-full px-14 py-7 ml-4">
        ...
        <div className="py-5 mr-10">
          <div className="py-5">{loadingComponent("Work Experience")}</div>
          <div className="py-5">{loadingComponent("Education")}</div>
          <div className="py-5">{loadingComponent("Projects")}</div>
        </div>
      </div>
    </div>
  );
