...
const ProjectStep: React.FC<Props> = ({ handleStepSubmit }) => {
  ...
  return (
    <CardBox>
      <div
        className='flex flex-col gap-2 max-h-[700px] overflow-y-scroll'
        style={{
          scrollbarWidth: projects.length > 1 ? 'auto' : 'none',
          paddingInlineEnd: projects.length > 1 ? '12px' : 'none',
        }}
      >
        <h1 className='font-bold text-3xl'>Project</h1>
        <span className='text-sm text-slate-500'>Share some projects you have done!</span>
        ...
        <div>
            ...
            return (
              <div key={i} className='mb-3'>
                ...
                <div className='grid grid-cols-12  gap-5'>
                  ...
                  <div className='col-span-6'>
                    <Label htmlFor={`position[${i}]`}>Project Position Title</Label>
                    <Input
                      type='text'
                  ...
                  <div className='col-span-6'>
                    <div className='grid grid-cols-6 gap-3'>
                      ...
                      <div className='col-span-6 flex flex-row align-middle gap-1 checkbox'>
                        <CheckboxComponent checked={project.isPresent} onChange={() => handleChecked(i)} />
          ...
          <div className='flex flex-col items-center'>
            <Button variant='secondary' className='w-full mb-5' onClick={handleAddProject}>
              Add More
            </Button>
